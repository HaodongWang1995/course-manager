    ...
    <section id="courses" className="bg-white px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-bold text-slate-900">Course Showcase</h2>
          <p className="mt-2 text-slate-500">See how courses and schedules look in EduManager</p>
        </div>
    ...
    <section className="px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div>
            <h2 className="text-3xl font-bold text-slate-900">Track Progress at a Glance</h2>
            <p className="mt-4 text-slate-500">
              Monitor student performance and course completion with intuitive visual indicators.
            </p>
            <div className="mt-8 space-y-6">
              ...
              <div>
                <div className="mb-2 flex justify-between text-sm">
                  <span className="font-medium text-slate-700">Assignments Graded</span>
              ...
              <div>
                <div className="mb-2 flex justify-between text-sm">
                  <span className="font-medium text-slate-700">Student Engagement</span>
          ...
          <Card className="flex flex-col justify-center">
            <CardHeader>
              ...
              <CardDescription>Jump right into your dashboard</CardDescription>
            </CardHeader>
